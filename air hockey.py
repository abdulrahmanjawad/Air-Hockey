...
while running:
    ...
    if (ball_x - ball_r <= 0) or (ball_x + ball_r >= screen_width):
        ball_xv = ball_xv * -1
    ...
    if (ball_x < paddle1_x + paddle1_w + 20 and ball_y >= paddle1_y and ball_y <= paddle1_y + paddle1_h):
        ball_xv = -ball_xv

    if (ball_x > paddle2_x - 20 and ball_y >= paddle2_y and ball_y <= paddle2_y + paddle2_h):
        ball_xv = -ball_xv
